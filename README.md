...
7. **Inbox UI (✓ shipped)** — `InboxPane` shows always-expanded Configured Entries / Files / Gmail sections, supports process/classify/accept/reject button actions, and uses the Files section as a local file drop target.
